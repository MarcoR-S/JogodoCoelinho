...
var starImg, star, star2, emptyStar, oneStar, twoStars, placar
...
function setup() 
{
  ...
  placar.scale = 0.2
  placar.addAnimation('empty',emptyStar);
  placar.addAnimation('uma',oneStar);
  placar.addAnimation('duas',twoStars);
  placar.changeAnimation('empty')
...
function collide(body,sprite,distancia)
{
  if(body!=null)
        {
...
function airBlow()
{
  if(fruit.position.x > 150 && fruit.position.x < 400 )
  {
